...
vault 改动流水：上述 4 个 skill 任一对 vault 笔记（`02_读书笔记/`、`11_entities/`、`12_concepts/`、`03_问答区/`）有写操作，或 lint-wiki 完成一次扫描 → 主对话必须在同次 commit 内 append `Log.md` 一条（详见 `10_schema/myconfig.md` §3 / §13）
4 skill 协作：
